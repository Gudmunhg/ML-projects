...
lreg = logistic_reg(lmb=0.000)

lreg.log_solver(X_train, Y_train, minibatch_size=250, n_epochs = 100, max_iter = 50, t0 = 0.1, t1 = 50)
print(f"Acc = {100*lreg.log_acc(X_test, Y_test):.2f}%")
lreg.plot_accuracy_eta(X_train, Y_train, X_test, Y_test)
